angular.module('reg')
    .constant('EVENT_INFO', {
        NAME: 'TechTogether Boston 2019',
    })
    .constant('DASHBOARD', {
        UNVERIFIED: 'You should have received an email asking you verify your email. Click the link in the email and you can start your application!',
        INCOMPLETE_TITLE: 'You still need to complete your application!',
        INCOMPLETE: 'If you do not complete your application before the [APP_DEADLINE], you will not be considered for admission to TechTogether Boston!',
        ...
        DECLINED: 'We\'re sorry to hear that you won\'t be able to make it to TechTogether Boston 2019! :(\nMaybe next year! We hope you see you again soon.',
    })
    .constant('TEAM',{
